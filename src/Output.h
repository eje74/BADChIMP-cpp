...
public:
//  // constructor
//    Variable(const std::string &_name, const std::vector<std::vector<double>::iterator> &data_itr, int _dim)
//  : name(_name),
//    data_iter_(data_itr),
//    dim(_dim)
//  {
...
//  }
    ...
    Variable(const std::string &_name, const std::vector<double>& data, const std::vector<int>& index, int _dim)
  : name(_name),
    data_(data),
    index_(index),
    dim(_dim)
...
private:
  ...
  //std::vector< std::vector<Variable>::iterator > scalars_, vectors_;
...
public:
  ...
  //void add_variable(const std::string &name, const std::vector<std::vector<double>::iterator> &data_itr, const int dim) {
