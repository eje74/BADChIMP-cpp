...
namespace VTK {
  ...
  public:
    ...
    {
      init();
      // offsets_ = util::linspace<int>(T::n, conn_.size(), T::n);
  ...
  private:
    ...
    //-----------------------------------------------------------------------------------
    {
      ...
      //std::vector<int> stride = {1,10,100};
      ...
      // util::print_vector(pts, T::dim);
      // util::print_vector(index, T::n);
      ...
      //std::cout << "pos: " << std::distance(pts.begin(),pos) << ", size: " << pts.size() << std::endl; 
