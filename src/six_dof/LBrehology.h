...
class QuemadaLawRheology
{
public:
    QuemadaLawRheology(const std::string file_name, const lbBase_t gamma_c);
...
//----------------------------------------------------------------------------------- QuemadaLawRheology
template <typename DXQY>
QuemadaLawRheology<DXQY>::QuemadaLawRheology(const std::string file_name, const lbBase_t gamma_c)
 ...
 */ 
{
    ...
    scaleX_ = 0.5*DXQY::c2Inv/gamma_c;
}
...
template <typename DXQY>
template<typename T1, typename T2, typename T3> 
lbBase_t QuemadaLawRheology<DXQY>::tau(const T1 &f, const lbBase_t& rho, const T2 &u, const lbBase_t& u_sq, const std::valarray<lbBase_t> &cu, const T3 &F) const
{
