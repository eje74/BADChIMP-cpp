...
class BoundaryExtended
{
public:
    BoundaryExtended(const std::vector<int> &bndNodes, const Nodes<DXQY> &nodes, const Grid<DXQY> &grid);
...
template <typename DXQY>
BoundaryExtended<DXQY>::BoundaryExtended(const std::vector<int> &bndNodes, const Nodes<DXQY> &nodes, const Grid<DXQY> &grid) : nBoundaryNodes_(static_cast<int>(bndNodes.size())),
...
template <typename DXQY>
void BoundaryExtended<DXQY>::addNode( int nodeNo,
                              int nBetaLinks,
                              int* betaLinkList,
                              int nGammaLinks,
                              int* gammaLinkList,
...
template <typename DXQY>
inline std::vector<int> BoundaryExtended<DXQY>::beta(const int bndNo) const
...
template <typename DXQY>
inline std::vector<int> BoundaryExtended<DXQY>::gamma(const int bndNo) const
...
template <typename DXQY>
inline std::vector<int> BoundaryExtended<DXQY>::delta(const int bndNo) const
...
template <typename DXQY>
inline int BoundaryExtended<DXQY>::dirRev(const int dir) const
...
template <typename DXQY>
inline int BoundaryExtended<DXQY>::nodeNo(const int bndNo) const
