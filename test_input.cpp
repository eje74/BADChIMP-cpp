...
int main() 
{
    // Input input2("GEOCHEM_BACK.trcinp", {{"keyword","*"}, {"end",""}}, Input::math_off | Input::missing_ok);
    ...
    auto series = input["math"]["series"];
    std::cout << series << std::endl;
    //std::cout << series.parent() << std::endl;            
    for (const auto& f : series["fibo"])
        std::cout << f << ", ";
